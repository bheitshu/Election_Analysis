...
with open(file_to_save, "w") as txt_file:   
    ...
    for county in county_votes:
        ...
        #print("county results: ", county_results)
         # 6e: Save the county votes to a text file.
        if (votes > winning_count): #and ( vote_percentage> winning_percentage) : 
            winning_count = votes
            largest_county = county
            county_voter_turnout=largest_county
            winning_county = vote_percentage
    ...
    largest_county_turnout = (
        #f"County Votes: {county_voter_turnout:}\n"
        f"\n-------------------------\n"
        f"Largest County Turnout: {largest_county}\n"
        f"-------------------------\n")
    total_county_turnout = (
        #f"County Votes: {county_voter_turnout:}\n"
        f"\n-------------------------\n"
        f"County Results: {county_results}\n"
        f"-------------------------\n")
...
#with open(file_to_save, "w") as txt_file:
    ...
    print("county results: ", county_results)
    txt_file.write(total_county_turnout)
